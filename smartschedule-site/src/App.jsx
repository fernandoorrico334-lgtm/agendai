...
const demoResult = {
  ...
  resumo_ia:
    "Lead com alta intenção de fechamento, buscando avaliação para treino personalizado e com preferência por atendimento no período da manhã.",
  resposta_ia:
...
const benefits = [
  ...
  },
  {
    ...
    text: "Cada minuto sem resposta reduz sua chance de venda. Com resposta rápida, você diminui perdas e aumenta conversão.",
  },
  {
    icon: ShieldCheck,
    title: "Operação mais organizada",
    text: "Status, contexto, horários e histórico ficam mais claros, deixando seu atendimento mais profissional e previsível.",
  },
  {
    icon: TrendingUp,
    title: "Mais clientes na agenda",
    text: "A proposta não é só automatizar. É transformar demanda em atendimento confirmado e mais oportunidades de venda.",
  },
];
...
const steps = [
  ...
  "A IA identifica a intenção e qualifica o contato.",
  "O sistema sugere horários e reduz atrito no agendamento.",
...
const trustPoints = [
  "Sistema pronto para negócios que dependem de agendamento",
  "Implantação personalizada conforme sua operação",
  "Fluxo comercial com foco em conversão",
];
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-4 pb-20 pt-10 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:pb-28 lg:pt-16">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="mt-6 max-w-5xl text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
              Seus leads chegam. A AgendAI responde, qualifica e agenda automaticamente. Você só fecha.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Cada minuto sem resposta é um cliente perdido. A AgendAI atende na hora, organiza tudo e transforma conversa em agendamento confirmado.
            </p>
            ...
            <p className="mt-2 text-xs text-slate-400">
              Sem compromisso • Demonstração rápida • Implementação personalizada
            </p>
